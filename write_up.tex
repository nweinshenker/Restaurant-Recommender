...
We will next evaluate the use of the different features available to reduce the number of features so that we are not suffering from the curse of dimensionality with all 7 of the features available.
}
