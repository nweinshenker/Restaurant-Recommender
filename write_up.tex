...
To understand k-NN, some necessary background information is needed in probability. 
Here are some basic probability definitions and terminology . \cite{4}
\begin{enumerate}
	...
	\item \begin{equation*}
	 ...
	 \end{equation*}
\end{enumerate}
Now for performing k-nearest neighbor classification,  lets assume X = training data; Y = class labels of X; and x = unknown sample.
\newline \newline
...
\end{equation} 
This is called a k-neighborhood of x (in D). \\ \\
